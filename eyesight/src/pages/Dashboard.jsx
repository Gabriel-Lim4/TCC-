...
import { FaBullhorn, FaTiktok } from "react-icons/fa";
import { FiTrendingUp, FiInstagram, FiArrowRight, FiRadio } from "react-icons/fi";
    ...
    <div className="dashboard-content">
      ...
      <div className="dash-platforms-row">
        ...
        <div className="card dash-platform-featured">
          ...
          <a href="/app/tiktok" className="dash-platform-link">
