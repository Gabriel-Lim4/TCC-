...
//
// Versão da API: sempre use uma versão fixa
// Isso evita quebras silenciosas
// ─────────────────────────────────────────────────────────────

import axios from 'axios';
import env   from '../config/env.js';

// Versão da Graph API — da pra mudar se precisar 
...
//
// 
// ela exige o APP SECRET — que nunca pode ir ao browser.
// Fluxo seguro:
...
// Isso é péssimo para um painel que precisa de dados sempre.
//
